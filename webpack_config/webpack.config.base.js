...
const _returnMultipleJSPEntryPoint = (pJspPageMapArr, isWithPolyfill) => { 
  ...
  pJspPageMapArr.forEach( p => entryPointArr.push(path.join(__dirname, '../', `./${p.js}`)))
...
module.exports = {
  ...
  ENTRY_POINT: _returnMultipleJSPEntryPoint(jspPageMapArr, true),
